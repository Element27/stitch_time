          ...
          <SignIn
            appearance={{
              variables: {
                ...
                colorText: '#FAF7F2',
                colorTextSecondary: '#D3C7B6',
                colorInputBackground: '#242220',
          ...
          <div className="w-full p-6 rounded-2xl bg-[#181715] border border-[#C89B3C]/30 text-center flex flex-col gap-4 shadow-xl">
            ...
            <div>
              ...
              <p className="text-xs text-[#9E948A] mt-1">
                You are currently running with local-first IndexedDB (Dexie.js). Add your Clerk keys to enable multi-device cloud login.
              </p>
            </div>
            <Link
              href="/"
