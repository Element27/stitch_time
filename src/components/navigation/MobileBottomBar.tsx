...
export function MobileBottomBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-[#1D222A]/95 backdrop-blur-md border-t border-[rgba(158,152,143,0.18)] safe-bottom">
              ...
              >
                <div
                  className={cn(
                    ...
                    isActive
                      ? "bg-[#F4EFEA] text-[#13161C] border-[#C89B5C] shadow-[#C89B5C]/50 scale-105 ring-2 ring-[#C89B5C]"
                      : "bg-[#C89B5C] text-[#13161C] border-[#F4EFEA] hover:scale-105 shadow-[#C89B5C]/30"
                  )}
                >
                  <Ruler className="w-6 h-6 stroke-[2.2]" />
                </div>
                <span className="text-[10px] font-mono font-bold text-[#C89B5C] mt-0.5 tracking-tight">
                  {item.label}
                </span>
              </Link>
            );
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  isActive ? "font-bold text-[#F4EFEA]" : "text-[#9E988F]"
                )}
              >
                {item.label}
              </span>
